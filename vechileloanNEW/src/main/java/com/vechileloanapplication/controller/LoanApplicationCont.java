...
@Validated
public class LoanApplicationCont {
	@Autowired
	private LoanApplicationServiceImpl loansAppService;

	public static Logger log = Logger.getLogger(LoanApplicationCont.class.getName());
...
//apply for a loan
		@PostMapping("/loanapplications/r/{userId}")
...
//Modify loan application status
	@PutMapping("/loanapplications/{userId}")
